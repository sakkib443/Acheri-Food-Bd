@php
    $quickLinks = ['Home', 'About Us', 'Shop', 'Offer Zone', 'Blog', 'Contact'];
        ...
        <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
                ...
                <div class="mt-5 flex gap-3">
                    {{-- Facebook --}}
                    <a href="#" aria-label="Facebook" class="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 transition hover:bg-[#f47b20]">
                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M9.198 21.5h4v-8.01h3.604l.396-3.98h-4V7.5a1 1 0 0 1 1-1h3v-4h-3a5 5 0 0 0-5 5v2.01h-2l-.396 3.98h2.396v8.01Z" />
                        </svg>
                    </a>
                    {{-- Instagram --}}
                    <a href="#" aria-label="Instagram" class="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 transition hover:bg-[#f47b20]">
                    ...
                    {{-- YouTube --}}
                    <a href="#" aria-label="YouTube" class="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 transition hover:bg-[#f47b20]">
                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {{-- WhatsApp --}}
                    <a href="#" aria-label="WhatsApp" class="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 transition hover:bg-[#f47b20]">
                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-3 text-sm text-gray-300">
                    ...
                    <li class="flex items-center gap-2.5">
                        ...
                        <a href="tel:+8801700000000" class="transition hover:text-[#f47b20]">+880 1700-000000</a>
                    </li>
                    <li class="flex items-center gap-2.5">
                        <svg class="h-5 w-5 shrink-0 text-[#f47b20]" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="mailto:info@acherifoodbd.com" class="transition hover:text-[#f47b20]">info@acherifoodbd.com</a>
                    </li>
                </ul>
            </div>
        </div>
